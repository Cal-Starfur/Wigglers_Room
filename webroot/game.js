...
function updateSnooDrain() {
  ...
  // Camera eases so the locked Snoo position sits comfortably in view (~0.58*H from top).
  // Derived from drainSnooStopY (world-Y) so the Snoo stays on screen at any canvas height.
  // The old fixed formula (~2.53*H) pushed him below the bottom edge on short/mobile viewports.
